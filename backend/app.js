...
//     var sql = "CREATE TABLE soiree (id INT AUTO_INCREMENT PRIMARY KEY, userId INT, userImage varchar(255), name VARCHAR(100), city VARCHAR(100), activity VARCHAR(100), address VARCHAR(255), lat FLOAT, lng FLOAT, date DATE, people INT, minYear INT, maxYear INT, gender VARCHAR(100))";
