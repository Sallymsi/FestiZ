...
//     var sql = "CREATE TABLE soiree (id INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(100), city VARCHAR(100), date DATE, people INT, minYear INT, maxYear INT, gender VARCHAR(100))";
